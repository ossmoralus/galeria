...
O projeto é construído com as tecnologias mais modernas do ecossistema JavaScript:
...
- **Next.js 16.0.6:** Framework React com App Router e Turbopack.
- **React 19.2.0:** Biblioteca UI.
- **TypeScript 5.6.0:** Tipagem estática ultra-strict.
- **Node.js 24.x:** Runtime JavaScript.

**Para detalhes sobre as bibliotecas de qualidade de código, MDX e CI/CD, consulte a [Documentação para Desenvolvedores](./docs/README.md).**
...
Contribuições são muito bem-vindas! Seja para reportar bugs, sugerir features, criar novos SVGs ou melhorar a documentação.

**Consulte o guia completo de contribuição:** [CONTRIBUTING.md](./CONTRIBUTING.md)

## 📚 Documentação Detalhada

Para informações aprofundadas sobre a estrutura do projeto, scripts de desenvolvimento, auditoria de licenças, e guias de criação de conteúdo, visite o índice completo:
